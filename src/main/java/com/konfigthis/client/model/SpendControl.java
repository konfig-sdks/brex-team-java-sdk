...
public class SpendControl {
  ...
  public SpendControl spendLimit(Money spendLimit) {
  ...
  **/
  ...
  public SpendControl spendAvailable(Money spendAvailable) {
  ...
  **/
  ...
  public SpendControl spendDuration(SpendDuration spendDuration) {
  ...
  **/
  ...
  public SpendControl reason(String reason) {
  ...
  **/
  ...
  public SpendControl lockAfterDate(LocalDate lockAfterDate) {
  ...
  **/
   ...
   * @return the SpendControl instance itself
   */
  public SpendControl putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SpendControl spendControl = (SpendControl) o;
    return Objects.equals(this.spendLimit, spendControl.spendLimit) &&
        Objects.equals(this.spendAvailable, spendControl.spendAvailable) &&
        Objects.equals(this.spendDuration, spendControl.spendDuration) &&
        Objects.equals(this.reason, spendControl.reason) &&
        Objects.equals(this.lockAfterDate, spendControl.lockAfterDate)&&
        Objects.equals(this.additionalProperties, spendControl.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SpendControl
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SpendControl.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SpendControl is not found in the empty JSON string", SpendControl.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SpendControl.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SpendControl.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SpendControl' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SpendControl> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SpendControl.class));

       return (TypeAdapter<T>) new TypeAdapter<SpendControl>() {
           @Override
           public void write(JsonWriter out, SpendControl value) throws IOException {
           ...
           @Override
           public SpendControl read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SpendControl instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SpendControl given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SpendControl
  * @throws IOException if the JSON string is invalid with respect to SpendControl
  */
  public static SpendControl fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SpendControl.class);
  }

 /**
  * Convert an instance of SpendControl to an JSON string
  *
  * @return JSON string
  */
